                            ...
                            <div class="mx-auto flex-shrink-0 px-10">
                                <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n5">
                                    <li aria-haspopup="true" aria-expanded="false"
                                        ...
                                        <a class="nav-link p-0" href="http://127.0.0.1:8000/">
                                            Home
                                    ...
                                    <li aria-haspopup="true" aria-expanded="false"
                                        class="nav-item dropdown-item-pages py-2 py-xl-7 sticky-py-xl-6 px-0 px-xl-5">
        ...
        <div class="card border-0 pt-4 pb-7 h-100">
            ...
            <div class="card-body px-6 pt-7 overflow-y-auto">
                <div class="mb-4 d-flex">
                    ...
                    <div class="media w-100">
                        <div class="w-60px mr-3">
                            <img src="images/product/product-01.jpg" alt="atural Coconut Cleansing Oil">
                        </div>
                        <div class="media-body d-flex">
                            <div class="cart-price pr-6">
                                <p class="fs-14 font-weight-bold text-secondary mb-1"><span
                                        class="font-weight-500 fs-13 text-line-t    hrough text-body mr-1">$39.00</span>₹
                                    3,58,755
                                </p>
                ...
                <div class="mb-4 d-flex">
                    ...
                    <div class="media w-100">
                        <div class="w-60px mr-3">
                            <img src="images/product/product-03.jpg" alt="Cleansing Balm">
                        </div>
                        <div class="media-body d-flex">
                            <div class="cart-price pr-6">
                                <p class="fs-14 font-weight-bold text-secondary mb-1"><span
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="nav-register" role="tabpanel" aria-labelledby="nav-register-tab">
                            ...
                            <form>
                                ...
                                <button type="submit" value="Login"
                                    class="btn btn-secondary btn-block bg-hover-primary border-hover-primary">Sign
                                    Up</button>
                                <div class="border-bottom mt-6"></div>
                                <div class="text-center mt-n2 lh-1 mb-4">
                    ...
                    <div class="row">
                                ...
                                <div class="view-slider-for mx-0">
                                    <div class="box px-0">
                                        <div class="card p-0 rounded-0 border-0">
                                            <a href="images/rings/IMG_20230220_151206.jpg" class="card-img">
                                    ...
                                    <div class="box px-0">
                                        <div class="card p-0 rounded-0 border-0">
                                            <a href="images/Necklaces/1/Necklaces_1_500x500.jpg" class="card-img">
                                                <img src="images/Necklaces/1/Necklaces_1_500x500.jpg"
                                                    alt="product gallery">
                                            </a>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6 pl-xl-6 pr-xl-8">
                            ...
                            <ul class="list-unstyled border-top pt-5 mt-5">
                                <li class="row mb-2">
                                    <span
                                        class="d-block col-4 col-lg-2 text-secondary font-weight-600 fs-14">Sku:</span>
                                    <span class="d-block col-8 col-lg-10 fs-14">SF09281</span>
                                </li>
                                <li class="row mb-2">
                                    <span
                                        class="d-block col-4 col-lg-2 text-secondary font-weight-600 fs-14">Categories:</span>
